window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        function SkillsSection(props) {
            ...
            // 文件选择：.md 与 .zip 均可多选；含 zip 时宿主自动解压并识别结构。
            const onPickFile = (event) => {
                ...
                if (files.length === 0)
                    return;
                ingestItems(files.map((file) => ({ name: file.name, path: file.webkitRelativePath || file.name, file })));
            };
                ...
                children: listState.status === "loading" ? (0, react_jsx_runtime.jsx)("p", {
                    ...
                    children: [
                        ...
                        (0, react_jsx_runtime.jsxs)("div", {
                            ...
                            children: [(0, react_jsx_runtime.jsx)("h3", { children: t("catalog") }), (0, react_jsx_runtime.jsx)("span", {
                                    ...
                                    children: [(0, react_jsx_runtime.jsx)("button", {
                                        ...
                                        (0, react_jsx_runtime.jsx)("span", {
                                            className: c.addTarget,
                                            title: scopeFilter === "global" ? t("scopeGlobal") : scopeFilter,
                        ...
                        (0, react_jsx_runtime.jsx)("input", {
                            ...
                            type: "file",
                            accept: ".md,.zip,application/zip,application/x-zip-compressed,text/markdown",
                            multiple: true,
                            onChange: onPickFile
                        }),
