...
function SkillsSection(props) {
			const { t, currentSessionId, listSkills, loadContent, setSkillEnabled, removeSkill, addSkill, listWorkspaces, batchMigrateSkill, listGroups, saveGroupSkill, deleteGroupSkill } = props;
			...
			const applyGroupDelete = () => {
				...
				if (typeof window !== "undefined" && !window.confirm(t("groupDeleteConfirm") + editor.name + "？")) return;
				setGroupEditor({ ...editor, busy: true, error: null });
